...
- Subscribe: ecolab/socket/4/control, ecolab/socket/4/timer, ecolab/socket/4/schedule/*
- Publish: ecolab/socket/4/energy, ecolab/socket/4/relaystatus, ecolab/socket/4/timer/status
- Publish: ecolab/socket/4/schedule/status, ecolab/socket/4/datetime/status
- LWT: ecolab/socket/4/devicestatus
...
def input_thread():
    ...
    print("\n" + "=" * 60)
    print("📝 INPUT BEBAN (LOAD CURRENT) - SOCKET 4")
    print("=" * 60)
...
def simulate_leds():
    ...
    print(f"\r[SOCKET 4] {status_str}    ", end="", flush=True)
...
def show_load_info():
    ...
    print(f"\n{'=' * 60}")
    print(f"📊 KONDISI SAAT INI - SOCKET 4")
    print(f"{'=' * 60}")
...
def main():
    ...
    print("=" * 60)
    print("EcoLab Smart Socket Simulator - Socket 4")
    print("=" * 60)
    print("Features:")
