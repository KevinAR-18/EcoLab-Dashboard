#!/usr/bin/env python3
"""
EcoLab Smart Socket Simulator (Python) - Socket 4
...
TOPIC_ENERGY = "ecolab/socket/4/energy"
TOPIC_DEVICE_STATUS = "ecolab/socket/4/devicestatus"
TOPIC_RELAY_STATUS = "ecolab/socket/4/relaystatus"
TOPIC_TIMER = "ecolab/socket/4/timer"
TOPIC_TIMER_STATUS = "ecolab/socket/4/timer/status"
TOPIC_SCHEDULE_START = "ecolab/socket/4/schedule/start"
TOPIC_SCHEDULE_STOP = "ecolab/socket/4/schedule/stop"
TOPIC_SCHEDULE_MODE = "ecolab/socket/4/schedule/mode"
TOPIC_SCHEDULE_STATUS = "ecolab/socket/4/schedule/status"
TOPIC_DATETIME_STATUS = "ecolab/socket/4/datetime/status"
...
running = True
SCHEDULE_FILE = "schedule_socket4.json"
...
def input_thread():
    ...
    while running:
        try:
            user_input = input("\n>> Masukkan beban Socket 4 (A): ").strip()
...
def simulate_leds():
    print(f"\r[SOCKET 4] MQTT: {'OK' if mqtt_connected else 'OFF'} | RELAY: {'ON' if relay_state else 'OFF'}    ", end="", flush=True)
