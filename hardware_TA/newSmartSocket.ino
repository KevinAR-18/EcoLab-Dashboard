...
// Schedule Topics (NEW: Start/Stop + Mode)
...
// ================= SCHEDULE (NEW: Start/Stop + Daily/Onetime Mode) =================
...
void setup()
{
    ...
    client.setKeepAlive(10);  // 10 detik keepalive (lebih cepat deteksi offline)
