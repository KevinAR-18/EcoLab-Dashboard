...
const char *mqtt_user = "smartsocket4";
const char *mqtt_pass = "smart4";

const char* client_id = "smartsocket4";

// MQTT topics
const char *topic_control = "ecolab/socket/4/control";
const char *topic_energy = "ecolab/socket/4/energy";
const char *topic_device_status = "ecolab/socket/4/devicestatus";
const char *topic_statusrelay = "ecolab/socket/4/relaystatus";

// ================= MQTT TOPIC TAMBAHAN =================
const char *topic_timer = "ecolab/socket/4/timer";
const char *topic_timer_status = "ecolab/socket/4/timer/status";

// Schedule Topics (Start/Stop + Mode)
const char *topic_schedule_start = "ecolab/socket/4/schedule/start";
const char *topic_schedule_stop = "ecolab/socket/4/schedule/stop";
const char *topic_schedule_mode = "ecolab/socket/4/schedule/mode";
const char *topic_schedule_status = "ecolab/socket/4/schedule/status";
