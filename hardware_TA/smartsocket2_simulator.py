...
- Publish: ecolab/socket/2/schedule/status, ecolab/socket/2/datetime/status
...
def input_thread():
    ...
    print("\n" + "=" * 60)
    print("📝 INPUT BEBAN (LOAD CURRENT) - SOCKET 2")
    print("=" * 60)
...
def simulate_leds():
    ...
    print(f"\r[SOCKET 2] {status_str}    ", end="", flush=True)
...
def show_load_info():
    ...
    print(f"\n{'=' * 60}")
    print(f"📊 KONDISI SAAT INI - SOCKET 2")
    print(f"{'=' * 60}")
...
def main():
    ...
    print("=" * 60)
    print("EcoLab Smart Socket Simulator - Socket 2")
    print("=" * 60)
    print("Features:")
