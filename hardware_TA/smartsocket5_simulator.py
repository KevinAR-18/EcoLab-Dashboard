...
- Subscribe: ecolab/socket/5/control, ecolab/socket/5/timer, ecolab/socket/5/schedule/*
- Publish: ecolab/socket/5/energy, ecolab/socket/5/relaystatus, ecolab/socket/5/timer/status
- Publish: ecolab/socket/5/schedule/status, ecolab/socket/5/datetime/status
- LWT: ecolab/socket/5/devicestatus
...
def input_thread():
    ...
    print("\n" + "=" * 60)
    print("📝 INPUT BEBAN (LOAD CURRENT) - SOCKET 5")
    print("=" * 60)
...
def simulate_leds():
    ...
    print(f"\r[SOCKET 5] {status_str}    ", end="", flush=True)
...
def show_load_info():
    ...
    print(f"\n{'=' * 60}")
    print(f"📊 KONDISI SAAT INI - SOCKET 5")
    print(f"{'=' * 60}")
...
def main():
    ...
    print("=" * 60)
    print("EcoLab Smart Socket Simulator - Socket 5")
    print("=" * 60)
    print("Features:")
