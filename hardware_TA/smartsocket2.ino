...
const char *mqtt_user = "smartsocket2";
const char *mqtt_pass = "smart2";

const char* client_id = "smartsocket2";

// MQTT topics
const char *topic_control = "ecolab/socket/2/control";
const char *topic_energy = "ecolab/socket/2/energy";
const char *topic_device_status = "ecolab/socket/2/devicestatus";
const char *topic_statusrelay = "ecolab/socket/2/relaystatus";

// ================= MQTT TOPIC TAMBAHAN =================
const char *topic_timer = "ecolab/socket/2/timer";
const char *topic_timer_status = "ecolab/socket/2/timer/status";

// Schedule Topics (Start/Stop + Mode)
const char *topic_schedule_start = "ecolab/socket/2/schedule/start";
const char *topic_schedule_stop = "ecolab/socket/2/schedule/stop";
const char *topic_schedule_mode = "ecolab/socket/2/schedule/mode";
const char *topic_schedule_status = "ecolab/socket/2/schedule/status";
