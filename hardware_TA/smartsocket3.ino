...
const char *mqtt_user = "smartsocket3";
const char *mqtt_pass = "smart3";

const char* client_id = "smartsocket3";

// MQTT topics
const char *topic_control = "ecolab/socket/3/control";
const char *topic_energy = "ecolab/socket/3/energy";
const char *topic_device_status = "ecolab/socket/3/devicestatus";
const char *topic_statusrelay = "ecolab/socket/3/relaystatus";

// ================= MQTT TOPIC TAMBAHAN =================
const char *topic_timer = "ecolab/socket/3/timer";
const char *topic_timer_status = "ecolab/socket/3/timer/status";

// Schedule Topics (Start/Stop + Mode)
const char *topic_schedule_start = "ecolab/socket/3/schedule/start";
const char *topic_schedule_stop = "ecolab/socket/3/schedule/stop";
const char *topic_schedule_mode = "ecolab/socket/3/schedule/mode";
const char *topic_schedule_status = "ecolab/socket/3/schedule/status";
